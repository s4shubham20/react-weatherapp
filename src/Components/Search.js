                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 mb-sm-3">
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control"name="city" id="city" placeholder="Enter city name here!" value={props.city}  onChange={props.change} />
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-md-3 mb-sm-3">
                            <div className="form-group">
                                ...
                                <div className="input-group mt-2">
                                    ...
                                    <input type="text" className="form-control" onChange={props.change} name="lon" id="lon" placeholder="Enter Longitude here!" value={props.lon}></input>
                                </div>
                            </div>
                        </div>
